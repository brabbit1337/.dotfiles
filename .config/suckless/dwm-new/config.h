...
static char dmenufont[]             = "MesloLGS Nerd Font:size=16";
static const char *fonts[]          = { "MesloLGS Nerd Font:size=16", "Hack Nerd Font Mono:size=16", "NotoColorEmoji:pixelsize=14:antialias=true:autohint=true"  };
...
/* gaps control */
	...
	{ MODKEY|ShiftMask,              XK_i,      incrigaps,      {.i = +1 } }, /* inner */
	{ MODKEY|Mod1Mask|ShiftMask,    XK_i,      incrigaps,      {.i = -1 } },
	{ MODKEY|ShiftMask,              XK_o,      incrogaps,      {.i = +1 } }, /* outer */
...
/* application bindings */
	...
	{ MODKEY|ShiftMask,	XK_h,          spawn,      {.v = (const char*[]){ "st", "-e", "btop", NULL } } },
